...
AUTOPLAY_OPTIONS = [
    # Fresh, concise categories — titles must contain 'live' or '247' to be selected
    discord.SelectOption(label="Rock Classics (Live)", value="rockclassics", description="Rock classics live streams"),
    discord.SelectOption(label="Rock (Live)", value="rock", description="Rock live stations"),
    discord.SelectOption(label="Praise (Live)", value="praise", description="Praise and gospel live streams"),
    discord.SelectOption(label="Worship (Live)", value="worship", description="Worship music live"),
    discord.SelectOption(label="Best Radio (Live)", value="bestradio", description="Top live radio stations"),
    discord.SelectOption(label="Jazz (Live)", value="jazz", description="Jazz live radio and stations"),
    discord.SelectOption(label="World News (Live)", value="worldnews", description="International live news streams"),
    discord.SelectOption(label="Podcasts (Live)", value="podcasts", description="Podcast streams and mixes (live-style)"),
    discord.SelectOption(label="Top 24/7 (Live)", value="top247", description="Popular 24/7 live streams (lofi, deep house, rain, news, podcasts)"),
    discord.SelectOption(label="Christmas (Live)", value="christmas", description="Christmas / holiday live stations"),
    discord.SelectOption(label="Chill (Live)", value="chill", description="Chill / relaxing live streams"),
    discord.SelectOption(label="Relaxing (Live)", value="relaxing", description="Relaxing ambient live streams"),
    discord.SelectOption(label="Drum & Bass (Live)", value="dnb", description="Drum & Bass / DnB live stations"),
    discord.SelectOption(label="Rainy Weather (Live)", value="rainy", description="Rain and nature ambient live streams"),
    discord.SelectOption(label="Deep House (Live)", value="deephouse", description="Deep house and lounge live streams"),
]
